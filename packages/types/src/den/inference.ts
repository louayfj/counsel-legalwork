...
export const INFERENCE_MODEL_ALIASES = {
  "openrouter/fusion": {
    ...
    displayName: "LegalWork: OpenRouter Fusion",
    enabled: true,
    usageFactor: 0.5,
  },
  "z-ai/glm-5.2": {
    upstreamModel: "z-ai/glm-5.2",
    displayName: "LegalWork: GLM 5.2",
    enabled: true,
    usageFactor: 0.5,
  },
  "moonshotai/kimi-k2.7-code": {
    upstreamModel: "moonshotai/kimi-k2.7-code",
    displayName: "LegalWork: Kimi K2.7",
    enabled: true,
    usageFactor: 0.5,
  },
  "tencent/hy3-preview": {
    upstreamModel: "tencent/hy3-preview",
    displayName: "LegalWork: Hy3 Preview",
    enabled: true,
    usageFactor: 0.5,
  },
  "moonshotai/kimi-k2.6": {
    upstreamModel: "moonshotai/kimi-k2.6",
    displayName: "LegalWork: Kimi K2.6",
    enabled: true,
    usageFactor: 0.5,
  },
  "deepseek/deepseek-v4-flash": {
    upstreamModel: "deepseek/deepseek-v4-flash",
    displayName: "LegalWork: DeepSeek V4 Flash",
    enabled: true,
    usageFactor: 0.5,
  },
  "minimax/minimax-m2.7": {
    upstreamModel: "minimax/minimax-m2.7",
    displayName: "LegalWork: MiniMax M2.7",
    enabled: true,
    usageFactor: 0.5,
  },
  "minimax/minimax-m3": {
    upstreamModel: "minimax/minimax-m3",
    displayName: "LegalWork: MiniMax M3",
    enabled: true,
    usageFactor: 0.5,
  },
  "z-ai/glm-5.1": {
    upstreamModel: "z-ai/glm-5.1",
    displayName: "LegalWork: GLM-5.1",
    enabled: true,
    usageFactor: 0.5,
  },
} as const;
