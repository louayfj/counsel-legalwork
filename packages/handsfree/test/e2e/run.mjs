...
const HELPER_APP = process.env.LEGALWORK_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/Axleo Computer Use.app");
...
try { execSync(`pkill -f 'Axleo Computer Use.app'`); } catch {}
