...
- SQLite at `~/.legalwork/opencode-router/opencode-router.db` unless overridden.
- Config stored at `~/.legalwork/opencode-router/opencode-router.json` (created by `opencode-router` or `pnpm -C apps/opencode-router setup`).
