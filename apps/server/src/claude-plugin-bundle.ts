...
export async function resolveClaudePluginBundle(input: { url: string; ref?: string }): Promise<ClaudePluginBundle> {
  ...
  if (manifest.hooks !== undefined) {
    warnings.push("This plugin declares hooks, which LegalWork does not support yet. Hooks were skipped.");
  }
  ...
  if (memberships.length === 0) {
    throw new ApiError(400, "plugin_empty", "This plugin has no MCP servers, skills, commands, or agents LegalWork can install.");
  }
