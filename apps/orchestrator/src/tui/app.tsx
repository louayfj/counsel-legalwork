...
const serviceCycle = ["all", "legalwork-orchestrator", "opencode", "legalwork-server", "router"];
          ...
          <Show when={state.view === "overview"}>
            <box flexDirection="row" gap={4} paddingTop={1}>
              ...
              <box width={Math.floor(dimensions().width / 2) - 4} flexDirection="column" gap={1}>
                ...
                <text fg={theme.textMuted}>LegalWork URL (LAN)</text>
                <text fg={theme.text}>{state.connect.legalworkUrl}</text>
                <text fg={theme.textMuted}>LegalWork Collaborator Token</text>
                <text fg={theme.text}>{state.connect.legalworkToken}</text>
                <Show when={state.connect.ownerToken}>
                  <text fg={theme.textMuted}>LegalWork Owner Token</text>
                  <text fg={theme.text}>{state.connect.ownerToken}</text>
                </Show>
                <text fg={theme.textMuted}>LegalWork Host Admin Token</text>
