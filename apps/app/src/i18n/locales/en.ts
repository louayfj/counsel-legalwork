...
export default {
  ...
  "mcp.quick_connect_box_desc": "Search matter files, folders, and metadata in the organization's Box, scoped to each user's permissions.",
  ...
  "mcp.quick_connect_dropbox_desc": "Search, read, and manage matter files in the organization's Dropbox. One-click sign-in with your Dropbox account.",
  "mcp.quick_connect_dropbox_title": "Dropbox",
  "mcp.quick_connect_egnyte_desc": "Search and summarize documents in the organization's Egnyte repository, governed by existing Egnyte permissions.",
  "mcp.quick_connect_egnyte_title": "Egnyte",
  "mcp.quick_connect_everlaw_desc": "Query Everlaw projects for documents, binders, and Bates metadata. US endpoint — org admin enables OAuth.",
  "mcp.quick_connect_everlaw_title": "Everlaw",
  "mcp.quick_connect_google_cloud_storage_desc": "Read and write matter files in the organization's Google Cloud Storage buckets, governed by IAM permissions.",
  "mcp.quick_connect_google_cloud_storage_title": "Google Cloud Storage",
  "mcp.quick_connect_highq_desc": "Read-only access to the organization's HighQ sites, documents, and iSheets. Enter your HighQ instance and site.",
  "mcp.quick_connect_highq_title": "Thomson Reuters HighQ",
  "mcp.quick_connect_imanage_desc": "Search documents and workspaces in the organization's iManage DMS, with access controls and per-call audit. Admin enables the MCP service.",
  "mcp.quick_connect_imanage_title": "iManage",
  "mcp.quick_connect_ironclad_desc": "Plain-language, permission-scoped search across Ironclad records. North America endpoint shown.",
  "mcp.quick_connect_ironclad_title": "Ironclad",
  "mcp.quick_connect_netdocuments_desc": "Search and retrieve documents from the organization's NetDocuments DMS. Sign in with your ndMAX Enterprise account.",
  ...
  "mcp.quick_connect_relativity_desc": "Query a RelativityOne instance in natural language — manage matters, workspaces, and access. Enter your tenant hostname and the Client ID from Relativity Support; you act as a signed-in System Administrator.",
  "mcp.quick_connect_relativity_title": "Relativity",
  "mcp.quick_connect_sharepoint_desc": "Search and manage matter files across the organization's SharePoint sites and OneDrive. Enter your tenant ID; admin consent required.",
  ...
  "skill_resources.staged_hint": "Attach Axleo templates or playbooks now — they are saved into the resources/ folder on create.",
  ...
  "whats_new.office.intro": "Draft, review, and annotate with the agent right next to your document.",
  ...
  "whats_new.office.redline_body": "In Word, the agent edits your document as tracked changes that you review and accept or reject.",
