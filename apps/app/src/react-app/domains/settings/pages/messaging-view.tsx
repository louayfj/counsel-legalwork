...
import { t } from "../../../../i18n";
import type {
  LegalworkOpenCodeRouterHealthSnapshot,
  LegalworkOpenCodeRouterIdentityItem,
  LegalworkOpenCodeRouterSendResult,
...
export type MessagingViewProps = {
  ...
  health: LegalworkOpenCodeRouterHealthSnapshot | null;
  ...
  telegram: {
    identities: LegalworkOpenCodeRouterIdentityItem[];
  ...
  sendTest: {
    ...
    status: string | null;
    error: string | null;
    result: LegalworkOpenCodeRouterSendResult | null;
  };
  modals: {
...
export function MessagingView(props: MessagingViewProps) {
  const serverReady = props.legalworkServerStatus === "connected";
  const scopedWorkspaceReady = Boolean(props.workspaceId?.trim());
  const workspaceScopeLabel =
    props.scopedLegalworkBaseUrl?.trim() || props.legalworkServerUrl.trim() || t("identities.not_set");
        ...
        <div className="mb-1.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              disabled={props.busy || props.legalworkReconnectBusy}
            >
