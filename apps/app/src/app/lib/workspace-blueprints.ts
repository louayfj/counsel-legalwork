...
export function blueprintSessions(config: WorkspaceLegalworkConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceLegalworkConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceLegalworkConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceLegalworkConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceLegalworkConfig>)
      : {};
