...
const starterRoot = "/Users/test/LegalWork/starter";
const otherRoot = "/Users/test/LegalWork/second";
...
try {
  ...
  step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\LegalWork\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\LegalWork\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\LegalWork\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/legalwork/starter");
  });
  ...
  step("round-trip invariant: every query path equals the create path (windows)", () => {
    ...
    const windowsPaths = [
      "C:\\Users\\Test\\LegalWork\\starter",
      "C:\\Users\\Test\\LegalWork\\starter\\",
      "D:\\projects\\my-app",
