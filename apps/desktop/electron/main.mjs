...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/louayfj/counsel-legalwork/releases/latest/download";
const RELEASE_PAGE_URL = "https://github.com/louayfj/counsel-legalwork/releases/latest";
