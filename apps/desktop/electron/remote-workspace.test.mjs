...
import {
  legalworkWorkspaceDisplayName,
  selectLegalworkWorkspaceForConnection,
} from "./remote-workspace.mjs";

describe("selectLegalworkWorkspaceForConnection", () => {
  it("selects the active worker workspace when no directory is provided", () => {
    const selected = selectLegalworkWorkspaceForConnection(
      {
        activeId: "ws_active",
        items: [
...
describe("legalworkWorkspaceDisplayName", () => {
